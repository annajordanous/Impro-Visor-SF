...
public class Tension 
{
    ...
    /**
     * Returns the metrical accent alignment of a phrase according to 
     * @param onsets
     * @param notes
     * @param tempo
     * @return 
    ...
    /**
     * Returns a list of the metrical hierarchies (Lerdahl and Jackendoff 1983) of each note in onsets
     * @param onsets
     * @return 
     */
    ...
    /**
     * Returns the metrical hierarchy (Lerdahl and Jackendoff 1983) of a note given its index in the slot array
     * @param index
     * @return 
     */
    ...
    /**
     * Returns the same syncopation value as getSyncopation but uses getMetricalHierarchy instead of WEIGHTS array
     * @param onsets
     * @return 
     */
    ...
    /**
     * Returns the same syncopation value as getWindowedSyncopation but uses getMetricalHierarchy instead of WEIGHTS array
     * @param onsets
     * @param measures
     * @param windowSize
     * @return 
