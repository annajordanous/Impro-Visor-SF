...
public class Stave
  ...
  static final private int[] notePosOffset = {24, 24, 20, 20, 16, 12, 12, 8, 8, 4, 4, 0};

  static final private int[] sharps = {77, 72, 79, 74, 69, 76, 71};

  static final private int[] flats = {71, 76, 69, 74, 67, 72, 65};

  static final private int[] lineNotes = {0, 1, 4, 7, 8, 11, 14, 15, 17, 18, 21, 22};
  ...
  static final int[] treblePitches = {61, 58, 54, 51, 48, 81, 84, 88, 91, 95};
  static final int[] bassPitches = {40, 37, 34, 30, 26, 60, 64, 67, 71, 74};
  static final int[] grandPitches = {40, 37, 34, 30, 27, 81, 84, 88, 91, 95};

  // Arrays of the y-axis offsets corresponding to each stave
  
  static final int[] trebleOffset = {40, 48, 56, 64, 72, -8, -16, -24, -32, -40};
  static final int[] bassOffset = {40, 48, 56, 64, 72, -8, -16, -24, -32, -40};
  static final int[] grandOffset = {88, 96, 104, 112, 120, -8, -16, -24, -32, -40};
          ...
          for( int j = 0; j <= tupletValue; ++j )
            ...
            */
            ...
            if( noteAtIndex != null 
             ...
             && noteAtIndex.getRhythmValue() % tupletBeatValue == 0
             
             // why? || tupletEndIndex - tupletStartIndex > beatValue
             )
              {
     ...
     if( beamed 
       ...
       if( beamNotes != null && !beamNotes.isEmpty() )
        ...
        beamNotes.add(new BeamNote(x1, y1, directionalStemCorrection, note.toLeadsheet()));
         ...
         int xs[] = {xStart, xStart,                 xEnd+1,               xEnd+1};
         int ys[] = {yStart, yStart + beamThickness, yEnd + beamThickness, yEnd};
