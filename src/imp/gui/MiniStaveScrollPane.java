...
public class MiniStaveScrollPane extends JScrollPane 
{
/**
...
protected MiniStave stave;


public MiniStaveScrollPane(int index)
{
  myIndex = index;
  BG = new JPanel();
}

public void setStave(MiniStave stave)
  {
  this.stave = stave;
  }

public MiniStave getStave()
  {
  return stave;
  }
...
public void addStave(MiniStave stave)
{
  BG.add(stave);
}
public JPanel getBG()
