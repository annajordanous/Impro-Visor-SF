...
/**
 * putLick puts the lick into the MelodyPart at the current selection without rectifying
 * @param lick
 * play - whether or not the lick should be played after being placed in. 
 * @return 
 */
...
//global pref
    ...
    {//GEN-HEADEREND:event_quantizeComboBoxscaleChosen
        ...
        {
            quantizeResolution = Integer.parseInt(quantizeString);
