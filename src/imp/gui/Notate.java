  ...
  */
   ...
   */
    ...
    private void initComponents()
    {
        ...
        mergeSectionPMI = new javax.swing.JMenuItem();
        splitSectionPMI = new javax.swing.JMenuItem();
        splitPhrasePMI = new javax.swing.JMenuItem();
        ...
        superColliderReadyButton.setPreferredSize(new java.awt.Dimension(428, 50));
        superColliderReadyButton.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                superColliderReadyButtonActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        mergeSectionPMI.setText("Merge Section with Previous");
        mergeSectionPMI.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                mergeSectionPMIActionPerformed(evt);
            }
        });
        popupMenu.add(mergeSectionPMI);

        splitSectionPMI.setText("Split into New Section");
        splitSectionPMI.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                splitSectionPMIActionPerformed(evt);
            }
        });
        popupMenu.add(splitSectionPMI);
        splitSectionPMI.getAccessibleContext().setAccessibleDescription("");

        splitPhrasePMI.setText("Split into New Phrase");
        splitPhrasePMI.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                splitPhrasePMIActionPerformed(evt);
            }
        });
        popupMenu.add(splitPhrasePMI);
...
public class SectionTableModel extends DefaultTableModel
{
    ...
    /**
     * Splits the section into a new one at the beginning of the measure.
     * @param isPhrase - true splits the section into a phrase, false splits it into a section
     */
    public void splitSection(boolean isPhrase){        
...
private void useImproviseButtonCheckBoxMIActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_useImproviseButtonCheckBoxMIActionPerformed
  {//GEN-HEADEREND:event_useImproviseButtonCheckBoxMIActionPerformed
   setUseImproviseCheckBox();
  }//GEN-LAST:event_useImproviseButtonCheckBoxMIActionPerformed
...
//global pref
    ...
    private void splitSectionPMIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_splitSectionPMIActionPerformed
        sectionTableModel.splitSection(false);
        savePrefs();
    }//GEN-LAST:event_splitSectionPMIActionPerformed

    private void splitPhrasePMIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_splitPhrasePMIActionPerformed
        sectionTableModel.splitSection(true);
        savePrefs();
    }//GEN-LAST:event_splitPhrasePMIActionPerformed

    private void mergeSectionPMIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mergeSectionPMIActionPerformed
        sectionTableModel.mergeSection();
        savePrefs();
    }//GEN-LAST:event_mergeSectionPMIActionPerformed
...
preferencesAcceleratorMI.setEnabled(true);
  ...
  private ImageIcon pauseButton =
    ...
    private javax.swing.JMenuItem mergeSectionPMI;
    ...
    private javax.swing.JMenuItem splitPhrasePMI;
    private javax.swing.JMenuItem splitSectionPMI;
