...
private void populateRecentFileMenu(javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_populateRecentFileMenu
  ...
  // For now, populate menu with dummy file names. 
  // Replace this with actual most recent names.
  ...
  for( String name: filenames )
   {
    // For each name in the menu, a new JMenuItem is created with that name.
    // For each such JMenuItem, an ActionListener is created which can get
    // at that name for opening as a file, due to the ActionListeners being
    // added to them as an inner class.
    
     final JMenuItem item = new JMenuItem(name);
    
    item.addActionListener(
      // Caution: inner class created
      new ActionListener()
      {
      public void actionPerformed(ActionEvent evt)
       {
        // Replace this with the file-opening code:
        
        System.out.println("You selected recent file: " + item.getText());
       }
