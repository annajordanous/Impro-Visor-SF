...
public class MIDIBeast{
	...
	public static int slotsPerMeasure = 480;
        ...
        public static String[] pitches = {"c", "c#", "d", "d#", "e", "f",
					  "f#", "g", "g#", "a", "a#", "b"};
	...
	/**
         ...
         *@param String chordFile
         * This method needs to be called before anything else is done with MIDIBeast.
         * It will take the midi and chord file and get basic info about the song,
        ...
        /**
         * Changes the value of the denominator and recalculates the values
         * of note rhythms
         */
        ...
        /**
         * Changes both the numerator and the denominator and recalculates the
         * value of note rhythms
         */
	...
	/**
         ...
         * method calulates how many slots each type of note should get. If a 
         * note type is note possible it is assigned a value of -1.
         *
         * This and the next method were fouling on half note triplets and quarter note triplets.
         * I changed them on 12/1/2007.
         * However, the whole thing should be checked over carefully.
         * RK
         */
		...
		else sixtyfourthtriplet = -1;
		
	}

	/**
         *@param numberOfSlots
         *Takes an integer number of slots and returns a string representation
         *of it that Impro-Visor's style specification will understand.
         */
        ...
        /**
         *@param d
         *Takes a double rhythm duration and turns it into an integer value 
	...
	/**
		...
		switch (num) {
		case 0: return "PIANO";
		case 3: return "HONKYTONK/HONKYTONK_PIANO";
		case 4: return "EPIANO/ELECTRIC_PIANO/ELPIANO";
		case 5: return "EPIANO2/DX_EPIANO";
		case 6: return "HARPSICHORD";
		case 7: return "CLAV/CLAVINET";
		case 8: return "CELESTE/CELESTA";
		case 9: return "GLOCKENSPIEL/GLOCK";
		case 10: return "MUSIC_BOX";
		case 11: return "VIBRAPHONE/VIBES";
		case 12: return "MARIMBA";
		case 13: return "XYLOPHONE";
		case 14: return "TUBULAR_BELL/TUBULAR_BELLS";
		case 16: return "ORGAN/ELECTRIC_ORGAN/";
		case 17: return "ORGAN2/JAZZ_ORGAN/HAMMOND_ORGAN";
		case 18: return "ORGAN3";
		case 19: return "CHURCH_ORGAN/PIPE_ORGAN";
		case 20: return "REED_ORGAN";
		case 21: return "ACCORDION/PIANO_ACCORDION/CONCERTINA";
		case 22: return "HARMONICA";
		case 23: return "BANDNEON";
		case 24: return "NYLON_GUITAR/NGUITAR/GUITAR/ACOUSTIC_GUITAR/AC_GUITAR";
		case 25: return "STEEL_GUITAR/SGUITAR";
		case 26: return "JAZZ_GUITAR/JGUITAR";
		case 27: return "CLEAN_GUITAR/CGUITAR/ELECTRIC_GUITAR/EL_GUITAR";
		case 28: return "MUTED_GUITAR/MGUITAR";
		case 29: return "OVERDRIVE_GUITAR/OGUITAR";
		case 30: return "DISTORTED_GUITAR/DGUITAR/DIST_GUITAR";
		case 31: return "GUITAR_HARMONICS/GT_HARMONICS/HARMONICS";
		case 32: return "ACOUSTIC_BASS/ABASS";
		case 33: return "FINGERED_BASS/BASS/FBASS/ELECTRIC_BASS/EL_BASS/EBASS";
		case 34: return "PICKED_BASS/PBASS";
		case 35: return "FRETLESS_BASS/FRETLESS";
		case 36: return "SLAP_BASS/SBASS/SLAP";
		case 38: return "SYNTH_BASS";
		case 40: return "VIOLIN";
		case 41: return "VIOLA";
		case 42: return "CELLO/VIOLIN_CELLO";
		case 43: return "CONTRABASS/CONTRA_BASS/DOUBLE_BASS";
		case 44: return "TREMOLO_STRINGS/TREMOLO";
		case 45: return "PIZZICATO_STRINGS/PIZZ/PITZ/PSTRINGS";
		case 46: return "HARP";
		case 47: return "TIMPANI/TIMP";
		case 48: return "STRINGS/STR";
		case 51: return "SLOW_STRINGS";
		case 50: return "SYNTH_STRINGS/SYN_STRINGS";
		case 52: return "AAH/AHHS/CHOIR";
		case 53: return "OOH/OOHS/VOICE";
		case 54: return "SYNVOX/VOX";
		case 55: return "ORCHESTRA_HIT";
		case 56: return "TRUMPET";
		case 57: return "TROMBONE";
		case 58: return "TUBA";
		case 59: return "MUTED_TRUMPET";
		case 60: return "FRENCH_HORN/HORN";
		case 61: return "BRASS";
		case 62: return "SYNTH_BRASS";
		case 64: return "SOPRANO_SAX/SOPRANO/SOPRANO_SAXOPHONE/SOP";
		case 65: return "ALTO_SAX/ALTO/ALTO_SAXOPHONE";
		case 66: return "TENOR_SAX/TENOR/TENOR_SAXOPHONE/SAX/SAXOPHONE";
		case 67: return "BARITONE_SAX/BARI/BARI_SAX/BARITONE/BARITONE_SAXOPHONE";
		case 68: return "OBOE";
		case 69: return "ENGLISH_HORN";
		case 70: return "BASSOON";
		case 71: return "CLARINET/CLAR";
		case 72: return "PICCOLO/PIC/PICC";
		case 73: return "FLUTE";
		case 74: return "RECORDER";
		case 75: return "PAN_FLUTE/PANFLUTE";
		case 76: return "BOTTLE_BLOW/BOTTLE";
		case 77: return "SHAKUHACHI";
		case 78: return "WHISTLE";
		case 79: return "OCARINA";
		case 80: return "SQUARE_WAVE/SQUARE";
		case 81: return "SAW_WAVE/SAW/SAWTOOTH";
		case 82: return "SYNTH_CALLIOPE/CALLOPE/SYN_CALLIOPE";
		case 83: return "CHIFFER_LEAD/CHIFFER";
		case 84: return "CHARANG";
		case 85: return "SOLO_VOX";
		case 88: return "FANTASIA";
		case 89: return "WARM_PAD/PAD";
		case 90: return "POLYSYNTH/POLY_SYNTH";
		case 91: return "SPACE_VOICE";
		case 92: return "BOWED_GLASS";
		case 93: return "METAL_PAD";
		case 94: return "HALO_PAD/HALO";
		case 95: return "SWEEP_PAD/SWEEP";
		case 96: return "ICE_RAIN/ICERAIN";
		case 97: return "SOUNDTRACK";
		case 98: return "CRYSTAL";
		case 99: return "ATMOSPHERE";
		case 100: return "BRIGHTNESS";
		case 101: return "GOBLIN";
		case 102: return "ECHO_DROPS/DROPS/ECHOS/ECHO/ECHO_DROP";
		case 103: return "STAR_THEME";
		case 104: return "SITAR";
		case 105: return "BANJO";
		case 106: return "SHAMISEN";
		case 107: return "KOTO";
		case 108: return "KALIMBA/THUMB_PIANO";
		case 109: return "BAGPIPES/BAG_PIPES/BAGPIPE/PIPES";
		case 110: return "FIDDLE";
		case 111: return "SHANNAI";
		case 112: return "TINKLE_BELL/BELL/BELLS";
		case 113: return "AGOGO";
		case 114: return "STEEL_DRUMS/STEELDRUMS/STEELDRUM/STEEL_DRUM";
		case 115: return "WOODBLOCK/WOODBLOCKS";
		case 116: return "TAIKO/DRUM";
		case 118: return "SYNTH_DRUM/SYNTH_DRUMS";
		case 119: return "TOM/TOMS/TOM_TOM/TOM_TOMS/REVERSE_CYMBAL/CYMBAL";
		case 120: return "FRETNOISE/FRET/FRETS";
		case 121: return "BREATHNOISE/BREATH";
		case 122: return "SEASHORE/SEA/RAIN/THUNDER/WIND/STREAM/SFX/SOUNDEFFECTS/SOUNDFX";
		case 123: return "BIRD";
		case 124: return "TELEPHONE/PHONE";
	...
	/**
         *@param pitchNumber
         *Returns the letter representation of a note given a MIDI pitch number.
         */
         ...
         *@param duration
         *@param precision
         *Rounds a rhythm in double form to slots with a given precision.
         */
        ...
        /**
         *@param s
         *Returns the number of slots a given string rhythm representation takes.
         */
        ...
        /**
         *@param ruleElement
         *Takes a rule element (eg X8+32) and returns just the rhythm part of it.
         *(eg 8+32).
         */
         ...
         *@param removeIndex
         *@param s
         *Takes an array of Strings and removes the specified index
         */
        public static String[] removeRule(int removeIndex, String[] s){
            ...
            for(int i = 0, index = 0; i < s.length; i++)
                if(i != removeIndex) toReturn[index++] = s[i];
            return toReturn;
        }
         ...
         *@param rhythmString
         *@param elementString
         *Takes a rule element(eg X8) and adds a rhythm element to it (eg 32)
         *TODO: Simplify the string after the rhythm is added
         */
        ...
        /**
         *@param rule
         *Finds how many slots an entire string bass rule contains
         */
	...
	/**
         *@param s
         *Takes a single string rhythm value (ie 8 or 16, not 16+32) and
         *returns the number of slots it contains
         *
         * RK: This wasn't not fully general. For example, it didn't handle more than one dot in a row.
		...
		if(s.equals("1")) return whole;
                if(s.equals("1.")) return whole+half;
		if(s.equals("2")) return half;
                if(s.equals("2.")) return half+quarter;
		if(s.equals("2/3")) return halftriplet;
		if(s.equals("4")) return quarter;
                if(s.equals("4.")) return quarter+eighth;
		if(s.equals("4/3")) return quartertriplet;
		if(s.equals("8")) return eighth;
                if(s.equals("8.")) return eighth+sixteenth;
		if(s.equals("8/3")) return eighthtriplet;
                if(s.equals("8/3.")) return eighth;
		if(s.equals("16")) return sixteenth;
                if(s.equals("16.")) return thirtysecond;
		if(s.equals("16/3")) return sixteenthtriplet;
                if(s.equals("16/3.")) return sixteenth;
		if(s.equals("32")) return thirtysecond;
                if(s.equals("32.")) return sixtyfourth;
		if(s.equals("32/3")) return thirtysecondtriplet;
                if(s.equals("32/3.")) return thirtysecond;
		if(s.equals("64")) return sixtyfourth;
		if(s.equals("64/3")) return sixtyfourthtriplet;
		return 0;
           */
	}
         ...
         *@param s
         *@param note
         *Takes the pitch number from a provided note object and returns a
         *String representation of it (eg D++)
         */
        public static String pitchToString(String s, Note note){
		if(note.getPitch() < 0) return "r";
		int offset = 57;
		char octave = '+';
		s += pitchOf(note.getPitch()%12);
		if(note.getPitch() > 71 || note.getPitch() < 60){
			if(note.getPitch() > 71){ offset = 71; octave = '+';}
			else if(note.getPitch() < 60){ offset = 60; octave = '-'; }
        ...
        /**
         *@param r
         *Takes a string rule and returns the rhythm value in double form.
         */
