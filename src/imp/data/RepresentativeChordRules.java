...
public class RepresentativeChordRules{
	...
	/**
	 * Changes the parts so it allows for changing what instrument part is the chord part.
	...
	/**
         ...
         * makeChordPattern without generating new rules
         **/
            ...
            try{
                ...
                if(im.canContinue == true){
                    ...
                    if(b.canContinue == true){
                        ...
                        if(MIDIBeast.maxChordPatternLength!=0.0) truncateChordPatterns();
                        processDuplicateRules();
                        if(debug){
	...
	*/
	...
	/**
	* This method iterates through the original set of rules and simplifies the pitch info contained
	* by calling on the simplifyPitchInfo method.
	*/
	public void simplifyRulePitches(){
        ...
        public ArrayList<String> getDuplicates(){ return duplicates; }
	
	/**
	* This method is called on each rule by simplifyRulePitches() 
	* and handles the logic involved in simplifying the pitch info
	...
	*/
	...
	/**
	* This method finds the tentative representatives for the clusters of each section. One
	* representative is found for each of the clusters that a sections is supposed to have.
	* The first representative is picked non deterministically, and all proceeding 
	* representatives are chosen by finding the pattern with the greatest distance
	...
	* and is added as a chord pattern with a weight equal to the 
