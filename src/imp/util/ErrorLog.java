...
private static ErrorDialog errorDialog = new ErrorDialog(true);

/** 
 * text in dialog 
 */

private static javax.swing.JTextPane errorText = errorDialog.getTextPane();

/** 
 * button in dialog 
 */

private static javax.swing.JButton okButton = errorDialog.getButton();


/**
 * Added summer 2007
 * Changes the title of the errorDialog to title
 **/
...
public static String log(int severity, String message)
  {
  return log(severity, message, true);
  }


public static String log(int severity, String message, boolean showDialog)
  {
  ...
  if( showDialog && errorDialog != null )
    {
